...
_lr_productions = [
  ...
  ('value -> ID','value',1,'p_value_id','ubasic_gram.py',105),
  ('value -> INTEGER','value',1,'p_value_integer','ubasic_gram.py',111),
  ('value -> STRING','value',1,'p_value_string','ubasic_gram.py',117),
  ('exp -> exp PLUS exp','exp',3,'p_exp_binary_exp','ubasic_gram.py',123),
  ('exp -> exp MINUS exp','exp',3,'p_exp_binary_exp','ubasic_gram.py',124),
  ('exp -> exp TIMES exp','exp',3,'p_exp_binary_exp','ubasic_gram.py',125),
  ('exp -> exp DIVIDE exp','exp',3,'p_exp_binary_exp','ubasic_gram.py',126),
  ('exp -> exp EQ exp','exp',3,'p_exp_binary_exp','ubasic_gram.py',127),
  ('exp -> exp LE exp','exp',3,'p_exp_binary_exp','ubasic_gram.py',128),
  ('exp -> exp AND exp','exp',3,'p_exp_binary_exp','ubasic_gram.py',129),
  ('exp -> exp OR exp','exp',3,'p_exp_binary_exp','ubasic_gram.py',130),
  ('exp -> ( exp )','exp',3,'p_exp_paren','ubasic_gram.py',136),
  ('exp -> MINUS exp','exp',2,'p_uminus_exp','ubasic_gram.py',142),
  ('exp -> NOT exp','exp',2,'p_not_exp','ubasic_gram.py',148),
  ('exp -> INTEGER','exp',1,'p_exp_integer','ubasic_gram.py',154),
  ('exp -> ID','exp',1,'p_exp_id','ubasic_gram.py',160),
  ('empty -> <empty>','empty',0,'p_empty','ubasic_gram.py',167),
]
